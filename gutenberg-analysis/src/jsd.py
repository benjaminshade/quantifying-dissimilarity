...
def jsdalpha(b1, b2, alpha=1.0, normalized=False, weights=False):
    r"""
    ...
    b1, b2 : dict
        ...
        Note that they already have the same support
    ...
    arr_p1, arr_p2 = get_p12_same_support(b1, b2)

    # Weighting of the two distributions
    if weights is False:
        pi1 = 0.5
    else:
        N1 = sum(list(b1.values()))
        N2 = sum(list(b2.values()))
        pi1 = N1/float(N1+N2)
